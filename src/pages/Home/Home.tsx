...
const Home = () => {
    ...
    console.log(scrolled, isWideEnoughForHorizontalGameCardsUwU)
    ...
    return (
        <div className="w-full flex flex-col-reverse 2xl:flex-row h-[calc(100%-1.5rem)] 2xl:h-full pt-6 2xl:pt-0 2xl:pr-4 bg-fullMoon dark:bg-night overflow-y-auto 2xl:overflow-y-hidden">
            ...
            <div ref={scrollContainerRef} className='flex flex-col gap-2 2xl:w-[216px] overflow-y-visible overflow-x-visible px-6 2xl:p-4 border-solid border-0 border-b 2xl:border-b-0 border-notQuiteBlack/20 dark:border-notQuiteWhite/20'>
                <h1 className={cn("block font-bold text-2xl hHLPLFVBBT2XLS:-mt-2 hHLPLFVBBT2XLS:mb-1 font-heading w-[216px]", scrolled ? "-translate-y-11" : "")}>{t("home.jumpBackIn")}</h1>
