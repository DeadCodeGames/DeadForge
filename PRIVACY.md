# Privacy Policy
**Last updated: [July 10, 2025]** <!-- 2025-07-10T09:39:53.574Z -->
...
| **External Image Hosting** | To download artwork for user-added software | No personal data sent, but your IP address may be logged by the image host | Legitimate interest (GDPR Art. 6(1)(f)) | Standard web requests initiated by the app |
